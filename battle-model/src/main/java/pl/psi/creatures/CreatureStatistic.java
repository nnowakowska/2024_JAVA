...
{
    // NECROPILIS FRACTION
    SKELETON( "Skeleton", 5, 4, 6, 4, 0,   Range.closed( 1, 3 ), 1,
        "Average lvl1 foot soldier, but always in huge numbers thanks to necromancy skill and skeleton transformer.",
        false ,false, Fraction.NECROPOLIS), //
    WALKING_DEAD( "Walking Dead", 5, 5, 15, 3,0,  Range.closed( 2, 3 ), 2,
        "Basically its the same skeleton with more hit points. I prefer buying 2 skeletons instead.", false,false, Fraction.NECROPOLIS ), //
    WIGHT( "Wight", 7, 7, 18, 5,0,  Range.closed( 3, 5 ), 3,
        ...
        false ,false, Fraction.NECROPOLIS), //
    VAMPIRE( "Vampire", 10, 9, 30, 6,0,  Range.closed( 5, 8 ), 4,
        ...
        false ,true, Fraction.NECROPOLIS), //
    LICH( "Lich", 13, 10, 30, 6,12,  Range.closed( 11, 15 ), 5,
        ...
        false,false , Fraction.NECROPOLIS), //
    BLACK_KNIGHT( "Black Knight", 16, 16, 120, 7, 0, Range.closed( 15, 30 ), 6,
        ...
        false ,false, Fraction.NECROPOLIS), //
    BONE_DRAGON( "Bone Dragon", 17, 15, 150, 9,0,  Range.closed( 25, 50 ), 7,
        ...
        false ,true, Fraction.NECROPOLIS), //
    SKELETON_WARRIOR( "Skeleton Warrior", 6, 6, 6, 5,0,  Range.closed( 1, 3 ), 1,
        ...
        true,false , Fraction.NECROPOLIS), //
    ZOMBIE( "Zombie", 5, 5, 20, 4,0,  Range.closed( 2, 3 ), 2,
        ...
        true ,false, Fraction.NECROPOLIS), //
    WRAITH( "Wraith", 7, 7, 18, 5,0, Range.closed( 3, 5 ), 3,
        "Regenerating ability is really good when fighting weak enemies, especially shooters.\nSpecial: top wight of the stack regenerates all lost damage in the beginning of each round\n",
        true,true, Fraction.NECROPOLIS ), //
    VAMPIRE_LORD( "Vampire Lord", 10, 10, 40, 9,0, Range.closed( 5, 8 ), 4,
        ...
        true,true, Fraction.NECROPOLIS ), //
    POWER_LICH( "Power Lich", 13, 10, 40, 7,24, Range.closed( 11, 15 ), 5,
        "Now they last longer and are able to do more damage! A must for good necropolis army.\nSpecial: death cloud range attack - damages living creatures on adjacent hexes to target.\n",
        true,false, Fraction.NECROPOLIS ), //
    DREAD_KNIGHT( "Dread Knight", 18, 18, 120, 9,0, Range.closed( 15, 30 ), 6,
        ...
        true ,false, Fraction.NECROPOLIS), //
    GHOST_DRAGON( "Ghost Dragon", 19, 17, 200, 14,0, Range.closed( 25, 50 ), 7,
    ...
    // CASTLE FRACTION
    PIKEMAN("Pikeman", 4, 5, 10, 4,0, Range.closed( 1, 3 ), 1,
        "Toughest lvl1 unit, but a bit slow.\n",
        false ,false, Fraction.CASTLE),//
    ARCHER("Archer", 6, 3, 10, 4,12, Range.closed( 2, 3 ), 2,
            "Archer's upgrade is literally 2 times better. Upgrade them quickly.\n",
            false,false, Fraction.CASTLE ),//
    GRIFFIN("Griffin", 8, 8, 35, 6,0, Range.closed( 3, 6 ), 3,
            "High in population, griffins become castle's main unit for the midgame.\n Special: can retaliate against 2 attacks per turn.\n",
            false ,true, Fraction.CASTLE),//
    SWORDSMAN("Swordsman", 10, 12, 35, 5,0, Range.closed( 6, 9 ), 4,
            "Not too good unit the upgrade and also too slow.\n",
            false,false, Fraction.CASTLE ),//
    MONK("Monk", 12, 7, 30, 5,12, Range.closed( 10, 12), 5,
            "Good shooter, nice damage.\n",
            false ,false, Fraction.CASTLE),//
    CAVALIER("Cavalier", 15, 15, 100, 7,0, Range.closed( 25, 25 ), 6,
            ...
            false ,false, Fraction.CASTLE),//
    ANGEL("Angel", 20, 20, 200, 12,0, Range.closed( 50, 50 ), 7,
    ...
    ZEALOT("Zealot", 12, 10, 30,7,24, Range.closed( 10,12 ), 5,
            ...
            true,false , Fraction.CASTLE),//
    CHAMPION("Champion", 16, 16, 100, 9,0, Range.closed( 20, 25 ), 6,
            "That's up to 45% extra damage possible! Champions also have better aiming skills. \n Special: +5% damage for each hex traveled to creature attacked.\n",
            true,false, Fraction.CASTLE ),//
    ARCHANGEL("Archangel", 30, 30, 250, 18,0, Range.closed(50, 50), 7,
        ...
        true ,true, Fraction.CASTLE),//
    // STRONGHOLD FRACTION
    GOBLIN("Goblin", 4, 2, 5, 5,0, Range.closed( 1, 3 ), 1,
            ...
            false ,false, Fraction.STRONGHOLD),//
    WOLF_RIDER("Wolf Rider", 7, 5, 10, 6,0, Range.closed( 2, 4), 2,
            ...
            false ,false, Fraction.STRONGHOLD),//
    ORC("Orc", 8, 4, 15, 4,12, Range.closed( 2, 5 ), 3,
            ...
            false ,false, Fraction.STRONGHOLD),//
    OGRE("Ogre", 13, 7, 40, 3, 0,Range.closed( 6, 12 ), 4,
            ...
            false,false , Fraction.STRONGHOLD),//
    ROC("Roc", 13, 11, 60, 7,0, Range.closed( 11, 15), 5,
            ...
            false ,true, Fraction.STRONGHOLD),//
    CYCLOPS("Cyclops", 15, 12, 70, 6,16, Range.closed( 16, 20 ), 6,
            ...
            false,false, Fraction.STRONGHOLD),//
    BEHEMOTH("Behemoth", 17, 17, 160, 6,0, Range.closed( 30, 50 ), 7,
            ...
            false ,false, Fraction.STRONGHOLD),//
    HOBGOBLIN("Hobgoblin", 5, 3, 5, 7,0, Range.closed( 1, 2 ), 1,
            ...
            true,false, Fraction.STRONGHOLD ),//
    WOLF_RAIDER("Wolf Raider", 8, 5, 10, 8,0, Range.closed( 3, 4 ), 2,
            "Awesome upgrade that makes wolves do about 2.5 times more damage. Defence and hit points remain the same, so use the sudden charge tactics. " +
                    ...
                    "a bad day.\n Special: Attacks twice.\n",
            true ,false, Fraction.STRONGHOLD),//
    ORC_CHIEFTAIN("Orc Chieftain", 8, 4, 20, 5, 24,Range.closed( 2, 5 ), 3,
            ...
            true,false, Fraction.STRONGHOLD ),//
    OGRE_MAGI("Ogre Magi", 13, 7, 60, 5,0, Range.closed( 6,12 ), 4,
            ...
            true ,false, Fraction.STRONGHOLD),//
    THUNDERBIRD("Thunderbird", 13, 11, 60,11,0, Range.closed( 11,15 ), 5,
            ...
            true,true, Fraction.STRONGHOLD ),//
    CYCLOPS_KING("Cyclops King", 17, 13, 70, 8,24, Range.closed( 16, 20 ), 6,
            ...
            true,false, Fraction.STRONGHOLD ),//
    ANCIENT_BEHEMOTH("Ancient Behemoth",19,19,300,9,0, Range.closed(30,50), 7,
   ...
   CreatureStatistic(final String aName, final int aAttack, final int aArmor, final int aMaxHp,
                                  final int aMoveRange, final int aShots, final Range< Integer > aDamage, final int aTier, final String aDescription,
                                  final boolean aIsUpgraded, final boolean aisFlying, Fraction aFraction)
    {
