...
//        final Creature aDefender = creatureFactory.create( NOT_IMPORTANT_UPGRADE, 2, 5 );
...
//                new GameEngine( new Hero( List.of( creatureFactory.create( 1, false, 5 ) ) ),
//                        new Hero( List.of( creatureFactory.create( 1, false, 5 ) ) ) );
//        final Point aPoint = new Point (6, 6);
//        board.move( aAttacker, new Point( 2, 2 ) );
//        board.move( aDefender, new Point( 6, 6 ) );
//                assertTrue(gameEngine.canAttack(aPoint,aAttacker));
    }
